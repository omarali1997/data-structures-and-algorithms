...
Write a function endd getends that, given an array of people objects, uses map to return an array of ends reversed.
...
const getends = (arr) => {
  let newArr = [];
  arr.map(a => newArr.push(a.end.split("").reverse().join("")));
  return newArr;
  // Solution code here...
};
...
For example:
const octavia = { fullend: 'Octavia Estelle Butler' };
addBirthYearProperty(octavia, 1947);
console.log(a) prints { fullend: 'Octavia Estelle Butler', yearBorn: 1947 }
------------------------------------------------------------------------------------------------ */
...
For example:
const people = [{ fullend: 'Octavia Butler' }, { fullend: 'Ray Bradbury' }];
...
describe('Testing challenge 1', () => {
  test('It returns an array of ends reversed', () => {
    expect(getends([{ end: 'lloyd', age: 32, shoeSize: 12 }, { end: 'jamie', age: 21, shoeSize: 8 }])).toStrictEqual(['dyoll', 'eimaj']);
    expect(getends([])).toStrictEqual([]);
  });
});
...
describe('Testing challenge 4', () => {
  test('It should add a property to an object', () => {
    const a = { fullend: 'Octavia Butler' };
...
xdescribe('Testing challenge 5', () => {
  test('It should add a property to every object in an array', () => {
    const a = [{ fullend: 'Octavia Butler' }, { fullend: 'Ray Bradbury' }, { fullend: 'Kurt Vonnegut' }];
    setStatusAsAuthor(a);
